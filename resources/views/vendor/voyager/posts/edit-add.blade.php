                    ...
                    <div class="panel panel panel-bordered panel-warning">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                @php
                                    $dataTypeRows = $dataType->{$edit ? 'editRows' : 'addRows'};
                                    $include = ['post_belongstomany_category_relationship', 'post_belongstomany_tag_relationship', 'sku', 'stock', 'price'];
                                @endphp
                    ...
                    <div class="panel panel-bordered panel-info">
                        <div class="panel-heading">
                            <h3 class="panel-title"><i class="icon wb-search"></i>
                                {{ __('voyager::post.seo_content') }}</h3>
                            <div class="panel-actions">
                                <a class="panel-action voyager-angle-down" data-toggle="panel-collapse"
                                    aria-hidden="true"></a>
                            </div>
...
<script>
    ...
    $('document').ready(function() {
        ...
        //select2 for posts categories
        $('.select_categories').select2({
            placeholder: "Select a Category"
        });

        //select2 for posts tags
        $('.select_tags').select2({
