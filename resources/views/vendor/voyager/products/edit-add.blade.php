        ...
        <form class="form-edit-add" role="form"
            ...
            <div class="row">
                <div class="col-md-8">
                    ...
                    <div class="panel">
                        <div class="panel-heading">
                            <h3 class="panel-title">{!! __('voyager::product.excerpt') !!}</h3>
                            <div class="panel-actions">
                                <a class="panel-action voyager-angle-down" data-toggle="panel-collapse"
                                    aria-hidden="true"></a>
                            </div>
                ...
                <div class="col-md-4">
                    <div class="panel panel panel-bordered panel-warning">
                        <div class="panel-heading">
                            <h3 class="panel-title"><i class="icon wb-clipboard"></i> {{ __('voyager::product.details') }}
                            </h3>
                            <div class="panel-actions">
                                <a class="panel-action voyager-angle-down" data-toggle="panel-collapse"
                                    aria-hidden="true"></a>
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                @php
                                    $dataTypeRows = $dataType->{$edit ? 'editRows' : 'addRows'};
                                    $include = ['product_belongstomany_category_relationship', 'product_belongstomany_tag_relationship', 'sku', 'stock', 'price'];
                                @endphp
...
<script>
    ...
    $('document').ready(function() {
        ...
        //select2 for products categories
        $('.select_categories').select2({
            placeholder: "Select a Category"
        });

        //select2 for products tags
        $('.select_tags').select2({
